...
<div class="card shadow mb-4" style="margin-bottom:20%;">
  <div class="card-header">
    <div class="row g-3">
        <div class="col">
         <h6 class=" font-weight-bold text-primary">Daftar Pengaduan Belum</h6>
        </div>
...
<div class="text-center">
    <div class="error mx-auto mt-5" data-text="Selesai 0" style="font-size:2.1rem;"> Pengaduan 0</div>
    <p class="lead text-gray-800 mb-5">Belum Ada Pengaduan</p>
